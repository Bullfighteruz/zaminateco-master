...
export const votingProjects: VotingProject[] = [
  {
    ...
    image: '/images/New Playground for School.jpg',
  ...
  {
    id: '2',
    title: 'Eco-Park Benches from Recycled Plastic and Tires',
    description: 'Create sustainable seating areas from recycled plastic and tires in Alisher Navoi Park',
    image: '/images/eco-park-benches.jpg',
  ...
  },
  {
    ...
    image: '/images/kindergarten-garden-path.jpg',
