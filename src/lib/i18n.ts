...
export const translations = {
  en: {
    ...
    engage50000Users: 'Engage 50,000+ active community participants',
    complete100Projects: 'Complete 100+ community infrastructure projects',
    plant10000Trees: 'Plant 10,000+ trees across Uzbekistan',
    recycled2500kg: 'Recycled plastic and rubber waste',
    active1250Members: 'Active community participants',
    launched3Projects: 'Launched pilot community projects',
    planted156Trees: 'Planted trees in urban areas',
  ...
  ru: {
    ...
    engage50000Users: 'Привлечь 50000+ активных участников сообщества',
    complete100Projects: 'Завершить 100+ проектов общественной инфраструктуры',
    plant10000Trees: 'Посадить 10000+ деревьев по всему Узбекистану',
    recycled2500kg: 'Переработано пластиковых и резиновых отходов',
    active1250Members: 'Активные участники сообщества',
    launched3Projects: 'Запущены пилотные общественные проекты',
    planted156Trees: 'Посажено деревьев в городских районах',
  ...
  uz: {
    ...
    recycle1000Tons: '1000+ tonna plastik va rezina chiqindini qayta ishlash',
    engage50000Users: '50,000+ faol jamiyat ishtirokchilarini jalb qilish',
    complete100Projects: '100+ jamiyat infratuzilma loyihalarini yakunlash',
    plant10000Trees: 'O\'zbekiston bo\'ylab 10,000+ daraxt ekish',
    recycled2500kg: 'Plastik va rezina chiqindi qayta ishlandi',
    active1250Members: 'Faol jamiyat ishtirokchilari',
    launched3Projects: 'Pilot jamiyat loyihalari ishga tushirildi',
    planted156Trees: 'Shahar hududlarida daraxtlar ekildi',
