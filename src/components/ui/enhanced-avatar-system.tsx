...
export const EnhancedAvatarSystem: React.FC<EnhancedAvatarSystemProps> = ({
  ...
  const avatarData = useMemo(() => ({
    emojis: ['👩‍🌾', '🌱', '🌿', '🌳', '♻️', '🌍', '💧', '☀️', '⚡', '🔥', '🌟', '🔮', '🦋'],
    images: ['/images/Eco Farmer.webp', '/images/Green Sprout.webp', '/images/Leaf Guardian.webp', '/images/Tree Protector.webp', '/images/Recycling Hero.webp', '/images/Earth Guardian.webp', '/images/Water Saver.webp', '/images/Solar Champion.webp', '/images/Energy Saver.webp', '/images/Climate Warrior.webp', '/images/Eco Star.webp', '/images/Future Visionary.webp', '/images/Nature Lover.webp'],
